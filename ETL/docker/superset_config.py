...
logger.info("superset_config.py has been loaded successfully")
...
SQLALCHEMY_DATABASE_URI = (
    ...
    f"{DATABASE_HOST}:{DATABASE_PORT}/{DATABASE_DB}?charset=utf8mb4"
)
...
try:
    ...
    #print("Debug: Using default Docker config")
